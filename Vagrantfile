...
EOF
    # hosts
    cat >>/etc/hosts<<EOF
192.168.56.30 cch.master k8s-master master
192.168.56.31 cch.node1 k8s-node-1 node1
192.168.56.32 cch.node2 k8s-node-2 node2
EOF
...
$configureNode = <<-SCRIPT
    ...
    sshpass -p "vagrant" scp -o StrictHostKeyChecking=no vagrant@192.168.56.30:/home/vagrant/kubeadm_join_cmd.sh .
